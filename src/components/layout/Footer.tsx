...
const Footer: React.FC = () => {
  return (
    <footer className="bg-secondary mt-auto py-6 border-t">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-semibold text-lg mb-4">ViewTube</h3>
            <p className="text-sm text-muted-foreground">
              A modern platform for video content creators and viewers, designed with simplicity and elegance in mind.
            </p>
          </div>
        ...
        <div className="mt-8 pt-4 border-t border-border/60 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
